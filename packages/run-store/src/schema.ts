...
CREATE INDEX idx_runs_selector ON runs (suite_content_hash, variant_name, created_at_utc);
CREATE INDEX idx_task_runs_run_id ON task_runs (run_id, task_id, repetition, attempt, task_run_id);
