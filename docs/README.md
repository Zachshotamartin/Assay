...
14. [Decision records](decisions/) contain the accepted ADRs, ADR-0001
    through ADR-0013, which fix the toolchain, name and scope boundary,
    ...
    stack, deterministic hashing of fractional task values, and ownership of
    runner orchestration. Reversals become new ADRs.
