...
for the Assay evaluation harness. Every gate, command, and measurement in this
document is `planned`.
...
| RUN-007 exit-code contract for all seven documented outcomes | e2e-simulated | outcome-forcing scenarios | 90s | gate (`e2e-simulated`) | $0 | ZF; blocks R1 |
...
- exit codes match the documented seven-outcome contract (FR-RUN-010);
