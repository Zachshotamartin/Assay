...
Implementation status: R0 and R1 have branch-local code and local evidence, but
neither gate is accepted. They implement no statistical comparison or judge
